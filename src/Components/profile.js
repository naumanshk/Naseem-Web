...
class profile extends Component {
            ...
            snapshot.forEach(school => {
                ...
                school.forEach(teachers => {
                    ...
                    if (teachers.key == localStorage.getItem("teacherId")) {
                        ...
                        this.setState({ address: teachers.val().address, name: teachers.val().userName, email: teachers.val().email, gender: teachers.val().gendar, fname: teachers.val().fatherName, schooldRef: teachers.val().refId,profileImg:teachers.val().profileImg })
    ...
    fileUpload() {
        ...
        const upload = storage.ref(`Profile/${localStorage.getItem('teacherId')}`).put(image);
        upload.on('state_changed',
            ...
            () => {
                storage.ref(`Profile/${localStorage.getItem('teacherId')}`).getDownloadURL().then(url => {
                    console.log(url);
